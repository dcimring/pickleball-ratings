...
export function Alerts() {
  ...
  return (
    <div className="max-w-2xl mx-auto px-6 pt-24 md:pt-32 pb-20 text-center min-h-full bg-background">
      <div className="mb-16 space-y-6">
        <div className="flex items-center justify-center gap-2">
          <Star className="w-4 h-4 text-primary fill-primary" />
          <span className="text-primary font-sans font-bold tracking-[0.2em] text-[10px] uppercase">Community Network</span>
        </div>
        <h1 className="text-6xl md:text-[7rem] font-display italic tracking-tighter text-foreground leading-[0.85]">
          Community <br />
          Alerts
        </h1>
        <p className="text-foreground/40 max-w-lg mx-auto font-medium text-lg text-balance">
